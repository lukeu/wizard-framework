 ...
 * will create the wizard with your own {@link WizardModel} implementation and
 * then call {@link Wizard#showInFrame} or one of the releated methods.
 * <p>
 * In the simplest case, you would subclass
 * {@link org.pietschy.wizard.models.StaticModel} and add a number of
...
public class Wizard extends JPanel {
     ...
     * causes the wizard to continue displaying the final step after finished has
     * been pressed. The wizard is closed when the user presses the close button.
     * This allows the wizard to display a final confirmation screen.
     *
     * @see #EXIT_ON_FINISH
     */
    ...
    /**
     * Called by the constructor to create the wizards title component. The default
     * component will be an instance of {@link DefaultTitleComponent} but subclasses
     * may override to provide a custom implementation. Typically the title
    ...
    /**
     * Gets the component being used to render the wizards title. By default this
     * will be an instance of {@link DefaultTitleComponent}. Subclasses can change
     * the default by overriding {@link #createTitleComponent()}.
     * <p>
     * For example, to activate the gradient background on the default title
     * component you can call.
     *
     * <pre>
    ...
    /**
     * Called by the constructor to create the button bar. Subclasses may override
     * to provide a custom {@link ButtonBar} implementation.
     *
    ...
    /**
     * Resets the wizard. This method delegates directly to
     * {@link WizardModel#reset}.
     */
    public void reset() {
        canceled = false;
        getModel().reset();
    ...
    /**
     * Configures the visibily of the overview panel that is displayed on the
    ...
    /**
     * Cancels this wizard. This method simply fires the
    ...
    /**
     * This method is called when the user cancels the wizard while the
    ...
    protected boolean confirmAbort() {
        int response = JOptionPane.showConfirmDialog(this, "Cancel the currently active task?", "Abort",
                JOptionPane.YES_NO_CANCEL_OPTION);
        return response == JOptionPane.YES_OPTION;
    }

    /**
     * Closes this wizard. This method simply fires the
     * {@link WizardListener#wizardClosed} event.
     */
    public void close() {
        fireWizardClosed();
    }
    ...
    /**
     * Caculates the preferred size of the main wizard area based on the
     * {@link WizardStep#getPreferredSize} values of all the wizard steps.
     */
    ...
    /**
     * Displays the wizard in a new {@link JFrame} with the specified title. The
     * frame will be automatically closed when the wizard is completed or canceled.
     ...
     * @see #removeWizardListener
     */
    public void showInFrame(String title, Image windowIcon) {
     ...
     * @see #removeWizardListener
     */
    public void showInFrame(String title, Component relativeTo) {
     ...
     * @see #removeWizardListener
     */
    public void showInFrame(String title, Image windowIcon, Component relativeTo) {
    ...
    /**
     * Displays the wizard in a new {@link JDialog} with the specified title. The
     * dialog will be automatically closed when the wizard is completed or canceled.
     * This method will block if the dialog is modal.
     *
     ...
     * @see #removeWizardListener
     */
    public void showInDialog(String title, Component parent, boolean modal) {
    ...
    /**
     * Displays this wizard in the specified {@link Window} that is positioned
     * relative to the specified component.
     *
