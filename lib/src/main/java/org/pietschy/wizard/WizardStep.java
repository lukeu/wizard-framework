...
public interface WizardStep {
     ...
     * may changed at any time by as long as an appropriate property change event is
     * fired.
     *
     ...
     * {@link #isBusy busy} state. This method will be called after the user has
     * confirmed the abort process and as such may be invoked after the step is no
     * longer busy.
     */
    void abortBusy();

    /**
     * This method must return the maximum preferred size of this wizard step. This
     * method will be called during wizard initialization to determine the correct
     * size of the wizard. This method will be called after {@link #init}.
     *
