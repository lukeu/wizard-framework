 ...
 * be dynamically removed from the wizard flow.
 *
 * <pre>
...
public class DynamicModel extends AbstractWizardModel {
     ...
     * {@link #add(WizardStep, Condition) add(step, (Condition)step)}, other wise it
     * is equivalent to calling
     * {@link #add(org.pietschy.wizard.WizardStep, Condition) add(step,
     * TRUE_CONDITION)}.
     * <p>
     * This allows the easy use of {@link WizardStep}s that determine the condition
     * under which they are displayed.
     *
    ...
    /**
     * Adds an optional step to the model. The step will only be displayed if the
     * specified condition is met.
     *
     * @param step      the {@link org.pietschy.wizard.WizardStep} to add.
     * @param condition the {@link Condition} under which it should be included in
     *                  the wizard.
     */
