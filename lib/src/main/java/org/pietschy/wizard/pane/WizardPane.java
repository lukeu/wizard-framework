 ...
 *
 * $Id: WizardPane.java,v 1.4 2005/05/16 23:07:01 pietschy Exp $
 */
...
WizardPane
{
    ...
    * is first initialising. You should get a reference to the {@link org.pietschy.wizard.WizardStep}
    * in order to call {@link org.pietschy.wizard.WizardStep#setComplete(boolean) when the step is filled with enough information,
    ...
    */
   public void
   init(WizardStep step, WizardModel model);
